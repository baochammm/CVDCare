  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-base-100 text-center px-4">
      <div className="bg-white shadow-lg rounded-2xl p-8 max-w-md w-full">
        ...
        <button className="btn btn-primary w-full mb-2" onClick={() => navigate("/predict")}>
          Back to Prediction
        </button>

        <button className="btn btn-primary w-full mb-2" onClick={() => navigate("/history")}>
          Go to History
        </button>

        <button className="btn btn-primary w-full mb-2" onClick={() => setShowFactors(true)}>
          View Key Factors
        </button>
        ...
        <button className="btn btn-primary w-full" onClick={() => setShowRecommendations(true)}>
